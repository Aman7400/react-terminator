...
const App = () => {
  ...
  const CMDs = {
    ...
    intro: () => {
      setOutput((prev) => [
        ...prev,
        {
          cmdInfo: 'intro',
          cmdOutput: [
            "Hello, I'm Aman Shukla, a Full Stack Javascript Developer. ",
          ],
        },
      ]);
    },
    ...
    github: () => {
      window.open(`https://github.com/Aman7400`);
    },
    source: () => {
      window.open(`https://github.com/Aman7400/react-terminator`);
    },
    findmeon: () => {
    ...
    resume: () => {
      window.open(
        'https://drive.google.com/file/d/1WNmFBWPWlgm0I2ZbkXsbfmW4k5eOzIvx/view?usp=sharing'
      );
    },
    ls: () => {
      setOutput((prev) => [
